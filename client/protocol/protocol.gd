...
const DESELECT_CONTRACT := "DESELECT_CONTRACT"
...
const CONTRACT_SELECTION := "CONTRACT_SELECTION"
...
const ERR_UNKNOWN_CONTRACT := "UNKNOWN_CONTRACT"
const ERR_BAG_OVERFLOW := "BAG_OVERFLOW"
const ERR_MISSING_GEAR := "MISSING_GEAR"
const ERR_CANNOT_KICK := "CANNOT_KICK"
const ERR_NOT_AT_EXTRACTION := "NOT_AT_EXTRACTION"
const ERR_NOT_AT_CONTRACT_BOARD := "NOT_AT_CONTRACT_BOARD"
const ERR_NOT_AT_QUARTERMASTER := "NOT_AT_QUARTERMASTER"
const ERR_NOT_AT_DEPLOY_GATE := "NOT_AT_DEPLOY_GATE"
const ERR_NO_CONTRACT_SELECTED := "NO_CONTRACT_SELECTED"

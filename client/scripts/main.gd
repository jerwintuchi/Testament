...
# Tiers are deliberately MIXED across the three bands (TD-094): notice.gd's PLEA lookup
# falls back rather than erroring, so a uniform fixture would let a missed rename pass
# a capture unnoticed. This also fits the longest (ANATHEMA) pleas through _fit_writ.
const _PREVIEW_BOARD := [
	{"contractId": "c-alpha", "tier": "VIGIL", "origin": "BELIEF", "targetName": "The Hollow Vicar",
	 "siteName": "The Gall Road Ossuary", "primaryVerb": "INVESTIGATE",
	 "requester": {"name": "Maret Ives", "role": "almoner", "place": "Greymarsh"}},
	{"contractId": "c-beta", "tier": "ANATHEMA", "origin": "SIN", "targetName": "The Drowned Choir",
	 "siteName": "Hollowmere Crossing", "primaryVerb": "BANISH",
	 "requester": {"name": "", "role": "reeve", "place": "The Old Mill"}},
	{"contractId": "c-gamma", "tier": "INTERDICT", "origin": "RELIC", "targetName": "The Unquiet Pilgrim",
	 "siteName": "The Broken Cloister", "primaryVerb": "ELIMINATE",
	 "requester": {"name": "Kestrel Vaun", "role": "lamplighter", "place": "Pilgrim's Rest"}},
	{"contractId": "c-delta", "tier": "VIGIL", "origin": "BELIEF", "targetName": "The Grey Congregant",
	 "siteName": "The Collapsed Chancel", "primaryVerb": "CAPTURE",
	 "requester": {"name": "Vidal Orr", "role": "chandler", "place": "Ashen Hollow"}},
	{"contractId": "c-eps", "tier": "INTERDICT", "origin": "RELIC", "targetName": "The Sunken Congregation",
	 "siteName": "Hollowmere", "primaryVerb": "INVESTIGATE",
	 "requester": {"name": "Brother Ames", "role": "sexton", "place": "Hollowmere"}},
	{"contractId": "c-zeta", "tier": "ANATHEMA", "origin": "SIN", "targetName": "The Gallows Shepherd",
	 "siteName": "Low Fen", "primaryVerb": "ELIMINATE",
	 "requester": {"name": "", "role": "pilgrim", "place": "Low Fen"}},
	{"contractId": "c-eta", "tier": "VIGIL", "origin": "BELIEF", "targetName": "The Ember Cantor",
	 "siteName": "Gall", "primaryVerb": "BANISH",
	 "requester": {"name": "Sister Wren", "role": "archivist", "place": "the Sunken Nave"}},
	{"contractId": "c-theta", "tier": "ANATHEMA", "origin": "RELIC", "targetName": "The Weeping Reliquary",

...
- `client/scripts/stations/quartermaster/room.gd:212` — `load/preload FLOOR`
- `client/scripts/stations/quartermaster/room.gd:225` — `load/preload path`
- `client/scripts/stations/quartermaster/room.gd:240` — `load/preload WALL`
- `client/scripts/stations/quartermaster/room.gd:361` — `load/preload CLOTH`
- `client/scripts/stations/quartermaster/room.gd:398` — `load/preload PROPS`
- `client/scripts/stations/quartermaster/room.gd:455` — `load/preload path`
- `client/scripts/stations/quartermaster/room.gd:468` — `load/preload path`

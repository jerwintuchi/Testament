...
- `client/scripts/stations/quartermaster/room.gd:505` — `load/preload CLOTH`
- `client/scripts/stations/quartermaster/room.gd:541` — `load/preload path`
- `client/scripts/stations/quartermaster/room.gd:550` — `load/preload PROPS`
- `client/scripts/stations/quartermaster/room.gd:608` — `load/preload path`
- `client/scripts/stations/quartermaster/room.gd:626` — `load/preload path`

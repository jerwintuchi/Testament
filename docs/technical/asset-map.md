...
- `client/scripts/stations/quartermaster/room.gd:217` — `load/preload FLOOR`
- `client/scripts/stations/quartermaster/room.gd:230` — `load/preload path`
- `client/scripts/stations/quartermaster/room.gd:245` — `load/preload WALL`
- `client/scripts/stations/quartermaster/room.gd:372` — `load/preload CLOTH`
- `client/scripts/stations/quartermaster/room.gd:409` — `load/preload PROPS`
- `client/scripts/stations/quartermaster/room.gd:466` — `load/preload path`
- `client/scripts/stations/quartermaster/room.gd:479` — `load/preload path`

...
- `client/scripts/stations/quartermaster/register.gd:138` — `load/preload SHEET`
- `client/scripts/stations/quartermaster/register.gd:256` — `load/preload RITE_SEAL`
- `client/scripts/stations/quartermaster/register.gd:452` — `load/preload RITE`
- `client/scripts/stations/quartermaster/room.gd:318` — `load/preload FLOOR`
- `client/scripts/stations/quartermaster/room.gd:333` — `load/preload path`
- `client/scripts/stations/quartermaster/room.gd:369` — `load/preload WALL`
- `client/scripts/stations/quartermaster/room.gd:488` — `load/preload CLOTH`
- `client/scripts/stations/quartermaster/room.gd:524` — `load/preload path`
- `client/scripts/stations/quartermaster/room.gd:533` — `load/preload PROPS`
- `client/scripts/stations/quartermaster/room.gd:591` — `load/preload path`
- `client/scripts/stations/quartermaster/room.gd:609` — `load/preload path`

...
import { handleDeselectContract } from './handlers/deselectContract.js';
...
export function routeMessage(
  ...
  switch (type) {
    ...
    case CLIENT_MESSAGES.SELECT_CONTRACT:
      ...
      break;
    case CLIENT_MESSAGES.DESELECT_CONTRACT:
      handleDeselectContract(socketId, roomManager, emit, broadcast);
      break;
